...
3. Running a bash script <a name="here"></a> [here](./home/adesoji/Automated-RDS-Backup-and-Restore-Strategy/Restore_strategy/execute_s3_script.sh) with the  instructions <a name="here"></a> [here](./Restore_strategy/instruction_for_restore_snapshot_py.md)
